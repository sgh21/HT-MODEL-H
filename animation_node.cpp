...
// #define KICK_FILE_NAME "/home/nvidia/thmos_ws/src/thmos_motion_config/kick.txt"
// #define DYNUP_FRONT_FILE_NAME "/home/nvidia/thmos_ws/src/thmos_motion_config/dynup_front.txt"
// #define DYNUP_BACK_FILE_NAME "/home/nvidia/thmos_ws/src/thmos_motion_config/dynup_back.txt"
#define KICK_FILE_NAME "/home/nvidia/params_ws/src/walk_params/kick.txt"
#define KICK_L_FILE_NAME "/home/nvidia/params_ws/src/walk_params/kick_left.txt"
#define DYNUP_FRONT_FILE_NAME "/home/nvidia/params_ws/src/walk_params/dynup_front.txt"
#define DYNUP_BACK_FILE_NAME "/home/nvidia/params_ws/src/walk_params/dynup_back.txt"
...
void callback(const bitbots_msgs::KickGoalConstPtr &goal, ActionServer* as,Pubs* p)
{
    if (goal -> kick_speed == 1) {
        ...
        start_msg.data = true;
        p->kick_start.publish(start_msg);
        publishMsg(&(p->kick_pub), p->kick_l_args);
        ROS_INFO ("-----Done kicking ball!-----");
        start_msg.data = false;
        p->kick_start.publish(start_msg);
    }
...
int main (int argc, char** argv) {
    ...
    Arguments* dynup_back_args = readArgs(DYNUP_BACK_FILE_NAME);
    Arguments* kick_args = readArgs(KICK_FILE_NAME);
    Arguments* kick_l_args = readArgs(KICK_L_FILE_NAME);
    if (!dynup_front_args || !dynup_back_args || !kick_args || !kick_l_args) {
    ...
    Pubs pubs = { kick_pub ,dynup_pub ,kick_start, dynup_front_args, dynup_back_args ,kick_args, kick_l_args};
